    ...
    public static function getProperties()
    {
        return [
            ...
            "skus"=> [
                "type"=> "nested",
                  "properties"=> [
                        "title"=> [ "type"=> "text", "analyzer"=> "ik_smart", "search_analyzer"=> "ik_smart_synonym", "copy_to" => "skus_title" ],
                        "description"=> [ "type"=> "text", "analyzer"=> "ik_smart", "search_analyzer"=> "ik_smart_synonym", 'copy_to'  => 'skus_description' ],
                        "price"=> [ "type"=> "scaled_float", "scaling_factor"=> 100 ]
                  ]
            ],
            "properties"=> [
